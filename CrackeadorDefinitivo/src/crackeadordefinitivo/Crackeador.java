...
public class Crackeador {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String rutaContrasenias = "contrasenias.txt";
        ...
        try {
            ...
            //En este bucle se lanzan los primeros usuarios en la cantidad de hebras especificadas
            for (int i = 0; i < hebras.length && user != null; i++) {
                Thread.sleep(1);
                HebraCrackeadora hebraCrackeadora = new HebraCrackeadora(user, rutaContrasenias, rutaPares,  ip, puerto);
